...
## Базовые URL
Все пути API относительны и не имеют префикса `/v1`.
...
### Получение аватара
- **`GET {without /api }/avatars/{user_id}.webp`**
...
Все эндпоинты в этой секции требуют роль `Admin`.
